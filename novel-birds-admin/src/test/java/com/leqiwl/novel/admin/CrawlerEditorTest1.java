...
public class CrawlerEditorTest1 {
    ...
    public void test() throws InterruptedException {
        ...
        CrawlerListRule listRule = CrawlerListRule.builder()
                .sourceUrl("https://www.biquge001.com/Top/lastupdate_[pageNo].htm")
                .pageStartRule(1)
                .pageEndRule(362)
                .afterInitPageNo(3)
                .getUrlListRule("//div[@class=\"novelslistss\"]/ul/li")
...
//                .scorePersonNumRule()
                ...
                .keywordsRule("//meta[@name=\"keywords\"]/@content")
                .keywordsReplaceRule(new ArrayList<>())
                .descriptionRule("//meta[@name=\"description\"]/@content")
        ...
        CrawlerContentRule contentRule = CrawlerContentRule.builder()
                ...
                .contentOutStr(CollectionUtil.newArrayList("笔趣阁"))
                .contentOutLabelRule(CollectionUtil.newArrayList("p","a"))
                .build();
